...
public class GouldUtil {
    ...
    //在高德申请的应用Key
    private static final String GOULD_KEY= "4db2c4780d5d33a34ec919297d4c165e";
    /**
     * 0.根据地址名称得到两个地址间的距离
     * @param start 起始位置
     * @param start 结束位置
     * @return 两个地址间的距离
     */
    public long getDistanceByAddress(String start, String end) throws Exception {
     ...
     * @return 经纬度
     */
    public String getLonLat(String address) throws Exception{
    ...
    public String getAMapByLngAndLat(String jwd) throws Exception {
        String url;
        try {
            url = "http://restapi.amap.com/v3/geocode/regeo?output=JSON&location=" + jwd
                    + "&key="+GOULD_KEY+"&radius=0&extensions=base";
            URL urlString = new URL(url);
            java.net.HttpURLConnection conn = (java.net.HttpURLConnection) urlString.openConnection();
